          ...
          {isAdding && (
            <div className="bg-[#15335E] border border-[#D5205D]/50 rounded-2xl p-6 mb-6 animate-fadeIn shadow-lg relative">
              ...
              <div className="flex gap-3 justify-end">
                <button onClick={() => {setIsAdding(false); setEditingId(null);}} className="text-slate-400 font-bold text-sm hover:text-white transition-colors">Cancelar</button>
                <button onClick={handleSaveItem} className="bg-white text-[#142239] px-6 py-2 rounded-lg font-bold text-sm hover:bg-slate-200 transition-colors">Salvar Experiência</button>
              </div>
            </div>
          )}
